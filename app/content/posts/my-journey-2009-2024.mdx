...
meta:
  ...
  date: '2024-09-07'
  title: 'My journey between 2009 - 2024'
---

This post is a way for me to reflect on the previous decades, but also to share highlights from it. There's a lot of text, in case you want to know highlights from my career and life. 🙂
...
I worked here for about 5 years. I learned and matured a lot throughout these years. I was lucky to end up in a company where you got involved in many parts of software development such as gathering requirements, design, development, build & deploy and collaborating with third party vendors.
...
I started my first (and only) assignment at [Ving](https://www.ving.se/) (nowadays known as Nordic Leisure Travel Group).
...
I was lucky to stay as a consultant here for 3 years. I feel that I got a lot of trust from my team and manager at Ving. I was able to tailor my own role as long as our team delivered what was expected.
...
This is where I met [Stefan Franzén](https://www.linkedin.com/in/stefanfranzen), who has had a great impact on my career (more on that further down).
...
I left Diabol and the world of consultancy just before the summer, because I got an offer to join Qred as a "Cloud Developer". I started there after the summer holidays.

The job title was a bit odd, but the idea was to convey that I was going to work with [Cloud Native software development](https://www.infoworld.com/article/3281046/what-is-cloud-native-the-modern-way-to-develop-software.html).
...
In March I was given the opportunity to switch to another team to work on the upcoming Qred VISA product. At this point I changed my title to Fullstack Developer, because I was helping out in both frontend and backend (mostly backend at this point).
...
I was now responsible for delivering new features, and I also was fully responsible for delivering that with the best quality possible. All the way out to production, and while the feature is in production.
...
In September/October, I switched back to the fullstack developer role. I'm ever greatful for my employer (Qred Bank AB) and Stefan for supporting me in this.
The main reasoning behind this decision was that I got further and further away from coding tasks, which wasn't really the path I wanted to be on.

There's more to write about this year, but I'll save that for a later time.
