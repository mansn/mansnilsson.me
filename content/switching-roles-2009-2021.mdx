...
It's hard to switch mindset being an Engineering Manager and individual contributor. I might write a separate post about this experience... but I'll add some text below on some initial thoughts I have on this.
...
If a team member is unhappy with anything, then I'll do my best to improve on that situation. I didn't really have to bother with that before (it doesn't mean that I didn't care though =)).
