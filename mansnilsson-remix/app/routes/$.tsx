import { json, type DataFunctionArgs, type LoaderFunction } from '@remix-run/server-runtime'
import { useLoaderData } from '@remix-run/react'
import { getMDXComponent } from "mdx-bundler/client/index.js";
import { useMemo } from 'react'
import type { Frontmatter} from 'utils/content.server';
import { getPost } from 'utils/content.server'
import type { V1_MetaFunction } from '@remix-run/server-runtime/dist/routeModules';
